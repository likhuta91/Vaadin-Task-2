...
public class HotelEditForm extends FormLayout {
	...
	public HotelEditForm(HotelView hotelView) {
		...
		binder.forField(name).withNullRepresentation("Name").asRequired("Please enter a name").bind(Hotel::getName, Hotel::setName);
		...
		binder.forField(rating).asRequired("Please enter a rating").withValidator(ratingValidator)
		...
		binder.forField(operatesFrom).asRequired("Please enter the opening date").withValidator(operatesFromValidator)
		.withConverter(new LocalDateToLongConverter()).bind(Hotel::getOperatesFrom,
				Hotel::setOperatesFrom);
		binder.forField(category).withNullRepresentation(new Category("No category")).asRequired("Please enter a category").bind(Hotel::getCategory, Hotel::setCategory);
